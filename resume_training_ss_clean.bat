...
REM Resumes the SS-Clean parametric training run from the latest checkpoint.
...
start "NAM Parametric Training - SS-Clean (resume)" /D "%~dp0" cmd /k "%~f0" --inner
exit /b 0
...
echo.
echo ============================================================
echo  NAM Parametric Training - SS-Clean - Resume
echo ============================================================
